...
// Doubt if the method has to have the same name of the node
  ...
  static final public MainClass MainClass() throws ParseException {
    ...
    jj_consume_token(RBRACE);
      {if (true) return new MainClass(class_id, id, stm);}
    throw new Error("Missing return statement in function");
  }
...
// this is the reason why the call to aux does no appear
  static final public ClassDecl ClassDecl() throws ParseException {
    ...
    jj_consume_token(CLASS);
    id = Id();
      {if (true) return ClassDecl_Aux(id);}
    throw new Error("Missing return statement in function");
  }

  static final public ClassDecl ClassDecl_Aux(Identifier class_id) throws ParseException {
                                                   // atention
    VarDecl var_dcl;
    ...
    case LBRACE:
      ...
      jj_consume_token(RBRACE);
              {if (true) return new ClassDeclSimple(class_id, var_list, mth_list);}
      break;
    case EXTENDS:
      ...
      jj_consume_token(RBRACE);
              {if (true) return new ClassDeclExtends(class_id, id, var_list, mth_list);}
      break;
    default:
      jj_la1[5] = jj_gen;
                  {if (true) return new ClassDeclSimple(class_id, var_list, mth_list);}
  ...
  static final public MethodDecl MethodDecl() throws ParseException {
    ...
    jj_consume_token(SEMI_COMMA);
    jj_consume_token(RBRACE);
      {if (true) return new MethodDecl( type, id, formal_list, var_list, stm_list, exp);}
    throw new Error("Missing return statement in function");
  }
...
// method type updated
  ...
  static final public Statement Statement() throws ParseException {
    ...
    case LBRACE:
      ...
      jj_consume_token(RBRACE);
          {if (true) return new Block(statement_list);}
      break;
    case IF:
      jj_consume_token(IF);
      jj_consume_token(LPAREN);
      ...
      elsestm = Statement();
          {if (true) return new If(exp, stm, elsestm);}
      break;
    case WHILE:
      ...
      jj_consume_token(RPAREN);
      stm = Statement();
          {if (true) return new While(exp, stm);}
      break;
    case PRINT:
  ...
  static final public Exp Exp() throws ParseException {
    ...
    case TRUE:
      jj_consume_token(TRUE);
          tr = new True();
          {if (true) return Exp_Aux(tr);}
      break;
    case FALSE:
      jj_consume_token(FALSE);
          fs = new False();
          {if (true) return Exp_Aux(fs);}
      break;
    case INTEGER_LITERAL:
      jj_consume_token(INTEGER_LITERAL);
          integer = new IntegerLiteral(Integer.parseInt(token.image));
          {if (true) return Exp_Aux(integer);}
      break;
    case ID:
      id = Id();
          id_exp = new IdentifierExp(id.toString());
          {if (true) return Exp_Aux(id_exp);}
      break;
    case THIS:
      jj_consume_token(THIS);
          th = new This();
          {if (true) return Exp_Aux(th);}
      break;
    default:
      jj_la1[13] = jj_gen;
      if (jj_2_4(2)) {
        ...
        jj_consume_token(RCOLCH);
          {if (true) return Exp_Aux(new_integer);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case NEW:
          jj_consume_token(NEW);
          ...
          jj_consume_token(LPAREN);
          jj_consume_token(RPAREN);
          {if (true) return Exp_Aux(new_obj);}
          break;
        case LPAREN:
          jj_consume_token(LPAREN);
          p_exp = Exp();
          jj_consume_token(RPAREN);
          {if (true) return Exp_Aux(p_exp);}
          break;
        case BANG:
          jj_consume_token(BANG);
          bang_exp = Exp();
          no = new Not(bang_exp);
          {if (true) return Exp_Aux(no);}
          break;
        default:
          jj_la1[14] = jj_gen;
          jj_consume_token(-1);
...
// doubt with the exp_aux and use of object declaration atribution
  static final public Exp Exp_Aux(Exp exp) throws ParseException {
    Exp exp_aux;
    And ad;
    Plus plus;
    Minus minus;
    ...
    case AND:
      ...
      exp_aux = Exp();
          ...
          {if (true) return Exp_Aux(ad);}
      break;
    case LESS_THAN:
      jj_consume_token(LESS_THAN);
      exp_aux = Exp();
          less = new LessThan(exp, exp_aux);
          {if (true) return Exp_Aux(less);}
      break;
    case PLUS:
      jj_consume_token(PLUS);
      exp_aux = Exp();
          plus = new Plus(exp, exp_aux);
          {if (true) return Exp_Aux(plus);}
      break;
    case MINUS:
      jj_consume_token(MINUS);
      exp_aux = Exp();
          minus = new Minus(exp, exp_aux);
          {if (true) return Exp_Aux(minus);}
      break;
    case TIMES:
      jj_consume_token(TIMES);
      exp_aux = Exp();
          times = new Times(exp, exp_aux);
          {if (true) return Exp_Aux(times);}
      break;
    case LCOLCH:
      jj_consume_token(LCOLCH);
